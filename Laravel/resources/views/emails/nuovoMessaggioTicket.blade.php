...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Salve, il contratto con ID {{$contractID}} intestato al contraente {{$nomeCustomer}} in cui è stato aperto un ticket ha ricevuto una risposta dal backoffice. Si consiglia di accedere al programma per leggere la conversazione. Grazie.</p>
