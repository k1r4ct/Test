...
class SupplierCategoryController extends Controller
{
    ...
    public function recuperaCategorieFornitori(){
    
        $categorieFornitori=supplier_category::all();
        return response()->json(["response" => "ok", "status" => "200", "body" => ["risposta" => $categorieFornitori]]);
    }
