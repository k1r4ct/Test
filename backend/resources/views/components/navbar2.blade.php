...
<div class="sidebar" style="overflow-y:auto">
    <div class="sidebar-brand" id="sidebarbrand" hidden style="margin-botom: 10rem;">
      <h1><img src="https://semprechiaro.com/wp-content/uploads/2022/09/logo-menu-semprechiaro-default.png" alt="" style="margin-left:3rem;" class="img-fluid">
      </h1>
    </div>
    ...
    <div class="sidebar-menu" style="margin-top: 10rem;">
      <ul>
        <li>
          <a href="{{route('home')}}" class="nav-link p-0 mt-1">
            <span class="fas fa-tachometer-alt"></span>
            <span>Dashboard</span>
          </a>
        </li>
        <li>
          <a href="{{route('clienti')}}"class="nav-link p-0 mt-1">
            <span class="fas fa-users" ></span>
            <span>Clienti</span>
          </a>
        </li>
        <li>
          <a href="{{-- {{route('waiters.showwaiters')}} --}}"class="nav-link p-0 mt-1">
            <span class="fas fa-file-signature" ></span>
            <span>Contratti</span>
          </a>
        </li>
        <li>
          <a href="{{-- {{route('restaurant.restaurant')}} --}}"class="nav-link p-0 mt-1">
            <span class="fas fa-hands-helping" ></span>
            <span>Punti Carriera</span>
          </a>
        </li>
        <li>
          <a href="{{-- {{route('ordini.ordini')}} --}}"class="nav-link p-0 mt-1">
            <span class="fas fa-hands-helping"></span>
        ...
        <li>
          <a href="{{-- {{route('wines.wines')}} --}}"class="nav-link p-0 mt-1">
            <span class="fas fa-code-branch"></span>
            <span>Lavorazioni</span>
          </a>
        </li>
        <li>
          <a href="{{-- {{route('statistiche.stat')}} --}}"class="nav-link p-0 mt-1">
